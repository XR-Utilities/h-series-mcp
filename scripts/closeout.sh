...
# Exclude the gate scripts from the content scans: they necessarily contain the
# very patterns they search for (the em dash literal, the secret-shape regexes)
# and would otherwise flag themselves.
